...
| 1 | Raw Material ↔ Formula ID unification (C2) | 🟡 In progress — resolver and DOE-to-charge test added |
| 2 | QC SOP data integrity (C3) | 🔲 Not started |
| 2A | DOE & model data contract | 🔲 Not started |
