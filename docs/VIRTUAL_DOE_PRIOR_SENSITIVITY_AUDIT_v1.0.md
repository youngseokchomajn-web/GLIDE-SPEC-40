...
|:---:|:---|:---|:---:|:---:|:---:|:---:|:---:|:---:|:---:|:---|
| **01** | `GS40-P001` | Vertex_HighSyn_HighDim | 15.0 | 22.0 | 80.0 | 785.4 [725-850] | 0.0430 [0.037-0.049] | 62.63 | 0.158 | **LOW (Nominal Core)** |
| **02** | `GS40-P002` | Vertex_HighSyn_LowDim_Tmin | 15.0 | 12.0 | 75.0 | 810.8 [748-877] | 0.0490 [0.043-0.055] | 62.38 | 0.150 | **LOW (Nominal Core)** |
| **03** | `GS40-P003` | Vertex_LowSyn_HighDim_Tmax | 9.0 | 22.0 | 85.0 | 711.3 [624-804] | 0.0490 [0.043-0.055] | 60.66 | 0.147 | **MEDIUM (Boundary Probe)** |
| **04** | `GS40-P004` | Vertex_LowSyn_LowDim | 9.0 | 12.0 | 80.0 | 736.6 [646-833] | 0.0540 [0.049-0.060] | 60.41 | 0.140 | **MEDIUM (Boundary Probe)** |
| **05** | `GS40-P005` | Axial_WaxMax | 15.0 | 17.0 | 75.0 | 789.3 [729-854] | 0.0470 [0.041-0.053] | 62.38 | 0.154 | **LOW (Nominal Core)** |
| **06** | `GS40-P006` | Axial_WaxMin | 9.0 | 17.0 | 85.0 | 732.7 [643-828] | 0.0510 [0.045-0.057] | 60.66 | 0.143 | **MEDIUM (Boundary Probe)** |
| **07** | `GS40-P007` | Axial_SilMax | 12.0 | 22.0 | 75.0 | 722.0 [654-795] | 0.0480 [0.043-0.054] | 61.27 | 0.152 | **MEDIUM (Boundary Probe)** |
...
| **12** | `GS40-P012` | Interior_High | 13.5 | 19.5 | 80.0 | 773.2 [708-842] | 0.0460 [0.040-0.052] | 62.07 | 0.153 | **LOW (Nominal Core)** |
